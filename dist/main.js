...
var CharItem = /*#__PURE__*/function (_Component) {
  ...
  _createClass(CharItem, [{
    ...
    value: function render() {
      ...
      var DOMChar = this.build(this.container, "div", {
        id: this.props.id,
...
/* harmony export */ });
/* harmony import */ var _lib_Component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../lib/Component */ "./src/lib/Component.js");
/* harmony import */ var _CharItem__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./CharItem */ "./src/components/CharItem.js");
...
var CharList = /*#__PURE__*/function (_Component) {
  ...
  function CharList() {
    ...
    (0,_index__WEBPACK_IMPORTED_MODULE_2__.register)('addMe', function () {
      return _this.render();
    });
    return _this;
  }
  _createClass(CharList, [{
    ...
    value: function charInput(e, i) {
      ...
      var newCharacteristics = _toConsumableArray(_index__WEBPACK_IMPORTED_MODULE_2__.state.characteristics);
      newCharacteristics[i].text = e.target.innerText;
      (0,_index__WEBPACK_IMPORTED_MODULE_2__.setState)("characteristics", newCharacteristics);
    ...
    value: function removeChar(i) {
      ...
      (0,_index__WEBPACK_IMPORTED_MODULE_2__.setState)("characteristics", newCharacteristics);
      var foundCharItem = document.getElementById("char-item".concat(i));
    ...
    value: function render() {
      ...
      var DOMChars = this.build(this.container, "div", {
        id: "characteristics-list",
        className: "characteristics-list"
      });
      // console.log("THE DOMCHARS ", DOMChars);
      this.DOMChars = DOMChars;
      _index__WEBPACK_IMPORTED_MODULE_2__.state.characteristics.forEach(function (characteristic, index) {
        var DOMCharItem = new _CharItem__WEBPACK_IMPORTED_MODULE_1__["default"](DOMChars, "div", {
          id: "char-item".concat(index),
...
var MainOptions = /*#__PURE__*/function (_Component) {
  ...
  _createClass(MainOptions, [{
    ...
    value: function render() {
      ...
      // HMM render should somehow perform the clearing of the container automatically...
      this.container.innerHTML = "";
      var DOMOptions = this.build(this.container, "div", {
        id: "main-options",
        className: "main-options"
      });
      var DOMAddMe = this.build(DOMOptions, 'button', {
        className: 'add-me',
        text: 'Add Me',
        onClick: function onClick() {
          return _this2.addMe();
      ...
      var DOMMainInput = this.build(DOMOptions, 'input', {
        className: 'main-input',
        text: _index__WEBPACK_IMPORTED_MODULE_1__.state.mainInput,
        onInput: this.props.updateMainInput
      });
...
/* harmony export */ });
/* harmony import */ var _lib_build__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./lib/build */ "./src/lib/build.js");
...
/* harmony import */ var _components_CharList__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/CharList */ "./src/components/CharList.js");
...
var updateMainInput = function updateMainInput(e) {
...
var render = function render() {
  ...
  DOMRoot.innerHTML = '';
  var main = (0,_lib_build__WEBPACK_IMPORTED_MODULE_0__.build)(DOMRoot, 'div', {
    className: 'main'
  });
  var DOMHeader = (0,_lib_build__WEBPACK_IMPORTED_MODULE_0__.build)(main, 'h1', {
    className: 'header',
    text: state.title
  });
  var DOMMainOptions = new _components_MainOptions__WEBPACK_IMPORTED_MODULE_3__["default"](main, 'div', {
    updateMainInput: updateMainInput
  });
  var DOMCharList = new _components_CharList__WEBPACK_IMPORTED_MODULE_2__["default"](main, 'div', {
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "div h1 {\n  color: blue;\n}", "",{"version":3,"sources":["webpack://./src/styles/style.scss"],"names":[],"mappings":"AAIE;EACE,WAAA;AAHJ","sourcesContent":["\ndiv {\n  // background: green;\n\n  h1 {\n    color: blue;\n  }\n  }\n"],"sourceRoot":""}]);
// Exports
